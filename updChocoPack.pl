...
my $url = "https://www.codecguide.com/download_k-lite_codec_pack_basic.htm";
my $last = "D:\\YandexDisk\\backup\\Chocolatey\\MyProject\\k-litecodecpackbasic\\last";
my $SoftName = "K-Lite Codec Pack Basic";
...
#exit;
#Пишем в файл nuspec
my $uspec = 'k-litecodecpackbasic.nuspec';
...
#`cd D:\\YandexDisk\\backup\\Chocolatey\\MyProject\\k-litecodecpackbasic && choco pack `;
#`cd D:\\YandexDisk\\backup\\Chocolatey\\MyProject\\k-litecodecpackbasic && choco push k-litecodecpackbasic.$version.nupkg`;
